                        ...
                        <div class="col-lg-12 mb-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">All Timesheets:</h6>
                                </div>
                                <div class="card-body">
                                  <form method="post" action="download_timesheets.php" align="center">
                                              <input type="submit" name="export" value="CSV Export" class="btn btn-success btn-lg btn-block" />
                                         </form>
                                  <form class="" action="download_timesheets.php" method="post" style="text-align: -webkit-center;">
                                    <?php
                                    ...
                                    while($row3 = mysqli_fetch_row($time_details))
                                    {
                                      ...
                                      if($timestamp_end == strtotime("0000-00-00 00:00:00")){
                                        ...
                                        $user_arr[] = array($row3[0],$row3[3],$row3[1],$row3[2], $hours_worked_per_shift);
                                    }
