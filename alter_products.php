                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Alter Price of Products:</h6>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Alter The Quantity of Products</h6>
                                </div>
                                <div class="card-body">
                                  <form class="dd" action="" method="post" >
                                  ...
                                  <tr>
                                    <td></td>
                                    <td><input class="btn btn-success" style="margin-top: 10px;" type="submit" value="Submit" name ="submit2" ><input style="margin-left: 4px; margin-top:10px;"class="btn btn-danger" type="reset" value="Reset"></td>
                                  </tr>
                                  </table>
